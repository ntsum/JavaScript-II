...
// Problem 1
//use .filter to filter through runners to find out the information of who donated less than 100 and give the information for each contestant. 
let donations = runners.filter(function(currentValue){
...
// Problem 2
//use .map to create a new array that will return with the last names of all of the contestants and lowercase all of the last names. 
let lower = runners.map(function(currentValue){
...
// Problem 3
//use the .foreach array method to display every email of the runners along with the donation amount for each email. 
let email = [];
runners.forEach(function(currentValue){
    email.push(currentValue.email + ' ' + currentValue.donation)
  });
console.log(email);